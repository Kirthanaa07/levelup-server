# Generated by Django 4.1.3 on 2023-11-25 18:37
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gamer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='game', to='levelupapi.gamer')),
            ],
        ),
        migrations.CreateModel(
            name='EventGamer',
        ...
        migrations.AddField(
            model_name='event',
            name='game',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='event', to='levelupapi.game'),
        ),
        migrations.AddField(
            model_name='event',
            name='organizer',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='event', to='levelupapi.gamer'),
        ),
    ]
